...
import { updateCoverImage } from "../../api/api";
import { AiOutlineClose } from "react-icons/ai";

function UpdateCoverImageModal({isOpen, onClose}) {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="w-1/4 bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">Update Cover Image</h2>
        ...
        <div className="mb-4">
          ...
          {coverImagePreview && (
            <div className="mb-4">
              <img src={coverImagePreview} alt="Avatar Preview" className="w-full h-auto rounded" />
            </div>
          )}
