...
const Sidebar = () => {
  return (
    <div className="bg-slate-300 text-black w-60 h-screen fixed left-0 top-0 py-20 flex flex-col -z-10 border-r-2 border-black">
      ...
      <NavLink to="/my-content" className="px-4 py-2 text-lg bg-white rounded-full my-1 mx-3 shadow-md">My Content</NavLink>
      <NavLink to="/collections" className="px-4 py-2 text-lg bg-white rounded-full my-1 mx-3 shadow-md">Playlist</NavLink>
      <NavLink to="/subscribers" className="px-4 py-2 text-lg bg-white rounded-full my-1 mx-3 shadow-md">Tweets</NavLink>
